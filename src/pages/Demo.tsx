...
import {
  Heart, MapPin, CalendarDays, Clock, ChevronDown,
  Music, UtensilsCrossed, Sparkles, Users, QrCode, ArrowRight,
} from 'lucide-react';
    ...
    <div className="bg-maroon-900 min-h-screen">
      ...
      <InviteSection id="story" kicker="كيف بدأت" title="قصتنا" light>
        <div className="relative max-w-xl mx-auto text-right">
          ...
          {[
            ...
            { icon: <Heart className="w-4 h-4" />, title: 'الخطوبة', text: 'بعد عامين، تقدّم عبدالله لخطبة نورة وسط سعادة العائلتين — وكانت أجمل ليلة.' },
      ...
      <InviteSection id="rsvp" kicker="شرّفونا بحضوركم" title="تأكيد الحضور" light>
        <div className="max-w-xl mx-auto">
          <div className="rounded-[32px] bg-white border border-gold-200 p-8 shadow-xl text-center">
            <QrCode className="mx-auto w-20 h-20 text-ink/40" strokeWidth={1.2} />
            <p className="mt-5 font-black text-ink tracking-[0.3em]" dir="ltr">DAWATAK-DEMO-0847</p>
            <p className="mt-4 text-ink/60 leading-8">
              الحجز التجريبي غير متاح حالياً — هذه معاينة فقط
            </p>
          </div>
        </div>
      </InviteSection>
