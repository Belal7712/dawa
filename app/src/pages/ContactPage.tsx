              ...
              <AnimatePresence mode="wait">
                {sent ? (
                  ...
                  >
                    ...
                    <h3 className="mt-6 text-2xl font-black text-ink">وصلنا طلبك!</h3>
                    <p className="mt-2 text-ink/55">فريقنا بيتواصل معك خلال دقائق عبر واتساب إن شاء الله.</p>
                  </motion.div>
                ) : (
                  <motion.form key="form" exit={{ opacity: 0, y: -16 }} onSubmit={submit} className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-2xl border-2 border-gold-200 bg-cream/60 px-5 py-3.5 outline-none transition-all focus:border-gold-500 focus:bg-white focus:ring-4 focus:ring-gold-500/10"
                        />
                      </div>
                      <div>
