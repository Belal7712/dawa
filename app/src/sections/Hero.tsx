...
import { MessageCircle, Star, ShieldCheck, ArrowLeft } from 'lucide-react';
          ...
          <div className="text-center lg:text-right order-2 lg:order-1">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="font-black text-ink">+4,000</span>
                <span className="text-ink/50 text-sm">مناسبة</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-black text-ink">4.9/5</span>
                <span className="text-ink/50 text-sm">تقييم</span>
              </div>
